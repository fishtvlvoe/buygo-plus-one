...
class DebugPage
{
    ...
    public function enqueue_scripts($hook): void
    {
        ...
        wp_localize_script('buygo-plus-one-debug-admin', 'buygoPlusOneDebug', [
            ...
            'nonce' => wp_create_nonce('buygo_plus_one_debug_nonce')
        ]);
    }
    ...
    {
        // 處理表單提交
        if (isset($_POST['action']) && wp_verify_nonce($_POST['_wpnonce'], 'buygo_plus_one_debug_action')) {
        ...
        <div class="wrap">
            ...
            <div class="debug-actions">
                <form method="post" style="display: inline;">
                    <?php wp_nonce_field('buygo_plus_one_debug_action'); ?>
            ...
            <div class="debug-filters">
                <form method="get" class="filters-form">
                    <input type="hidden" name="page" value="buygo-plus-one-debug">
                    ...
                    <div class="filter-row">
                        ...
                        <div class="filter-group">
                            ...
                            <a href="<?php echo admin_url('admin.php?page=buygo-plus-one-debug'); ?>" class="button">清除</a>
                        </div>
                    </div>
                </form>
            </div>
    ...
    {
        if (!wp_verify_nonce($_REQUEST['nonce'] ?? '', 'buygo_plus_one_debug_nonce')) {
            wp_die('安全驗證失敗');
        }
