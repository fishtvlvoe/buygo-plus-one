...
Plans:
- [x] 34-01-PLAN.md — 出貨通知模板定義（前端 templateDefinitions + 後端 definitions）
- [x] 34-02-PLAN.md — 預計送達時間輸入欄位（出貨單 Modal + API + 資料庫）

**Status:** ✅ Completed 2026-02-02

**Note:** 前端顯示 4 種通知類型但後端只有 shipment_shipped 有預設模板是刻意設計。其他通知已透過 LineOrderNotifier 運作，使用者可自訂模板內容。
...
| 34. 模板管理介面 | 2/2 | ✅ Complete | 2026-02-02 |
