...
- 🚧 **v3.2 批量上架前端** - Phases 57-59 (active)
...
- [ ] **Phase 57: 路由與數量選擇** - 新增「+上架」入口按鈕 + SPA 路由 + 數量選擇頁完整體驗
- [ ] **Phase 58: 批量表單 + CSV 匯入** - 響應式批量表單（手機卡片/桌面表格）+ CSV 解析填入
- [ ] **Phase 59: 提交與結果回饋** - 提交驗證 + API 呼叫 + 成功/失敗處理 + 桌面提示
...
Plans:
- [ ] 57-01-PLAN.md — SPA 路由註冊 + 商品列表頁「+ 上架」按鈕
- [ ] 57-02-PLAN.md — 數量選擇頁 UI（快選按鈕 + 自訂輸入 + 配額 + CTA）
...
| Phase | Milestone | Plans Complete | Status | Completed |
|-------|-----------|----------------|--------|-----------|
| 57. 路由與數量選擇 | v3.2 | 0/2 | Planning | - |
| 58. 批量表單 + CSV 匯入 | v3.2 | 0/TBD | Not started | - |
| 59. 提交與結果回饋 | v3.2 | 0/TBD | Not started | - |
