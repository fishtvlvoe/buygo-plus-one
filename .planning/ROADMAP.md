...
## ✅ v1.4 會員前台子訂單顯示功能 (SHIPPED 2026-02-02)
...
Plans:
- [x] 35-01-PLAN.md — FluentCart Hook 整合基礎，注入按鈕和容器
...
Plans:
- [x] 36-01-PLAN.md — ChildOrderService 子訂單查詢服務（QUERY-01~04）
- [x] 36-02-PLAN.md — ChildOrders_API REST 端點（API-01~04）
...
Plans:
- [x] 37-01-PLAN.md — 前端 UI 元件完整實作（JavaScript API 呼叫、CSS 樣式、訂單 ID 傳遞）
...
| 37. 前端 UI 元件與互動 | 1/1 | Complete | 2026-02-02 |
