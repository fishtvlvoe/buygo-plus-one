...
?>
<!-- Shipment Products Page Styles - inline 繞過 InstaWP WAF -->
<style><?php include plugin_dir_path(dirname(__FILE__)) . 'css/shipment-products.css'; ?></style>
<?php

// 設定 Header 參數
$header_title = '備貨';
$header_breadcrumb = '<a href="/buygo-portal/dashboard" class="">首頁</a> <span class="text-slate-300">/</span> <span class="active">備貨</span>';
...
// 將 Header 加入模板
$shipment_products_component_template .= $header_html;
...
$shipment_products_component_template .= <<<'HTML'
    ...
    <div>
        ...
        <div v-else-if="error" class="text-center py-8">
            ...
            <button @click="loadShipments" class="btn btn-primary mt-4">重新載入</button>
        </div>
        ...
        <div v-else>
            ...
            <!-- 統一分頁樣式 -->
            <div class="pagination-container" v-if="totalShipments > 0">
